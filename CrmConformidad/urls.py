...
from .views import CasoListCreateView, PerfilUsuarioView, CasoDetailView, CasoUploadDocsView, DocDeleteView, AuthLoginView, AuthRegisterView,AuthMeView,AdminRolesView, AdminPermisosCatalogView, AdminUsuariosCreateView
