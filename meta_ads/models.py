...
class CampanaMeta(models.Model):
    ...
    presupuesto_anuncio = models.DecimalField(
        max_digits=14,
        decimal_places=2,
        null=True,
        blank=True,
    )
    coste_resultados = models.DecimalField(
        max_digits=14,
        decimal_places=2,
        null=True,
        blank=True,
    )
    importe_gastado = models.DecimalField(
        max_digits=14,
        decimal_places=2,
        null=True,
        blank=True,
    ...
    importe_gastado_fb = models.DecimalField(
        max_digits=14,
        decimal_places=2,
        null=True,
        blank=True,
    ...
    importe_gastado_ig = models.DecimalField(
        max_digits=14,
        decimal_places=2,
        null=True,
        blank=True,
    ...
    importe_gastado_wsp = models.DecimalField(
        max_digits=14,
        decimal_places=2,
        null=True,
        blank=True,
    ...
    importe_gastado_masc = models.DecimalField(
        max_digits=14,
        decimal_places=2,
        null=True,
        blank=True,
    ...
    importe_gastado_fem = models.DecimalField(
        max_digits=14,
        decimal_places=2,
        null=True,
        blank=True,
    ...
    importe_gastado_sin_genero = models.DecimalField(
        max_digits=14,
        decimal_places=2,
        null=True,
        blank=True,
